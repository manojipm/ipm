...
(function(e, t, n, r) {
    FixedColumns = function(e, t) {
        ...
        this.s.dt._bInitComplete ? this._fnConstruct(t) : this.s.dt.oApi._fnCallbackReg(this.s.dt, "aoInitComplete", function() {
            n._fnConstruct(t)
        }, "FixedColumns")
    };
    FixedColumns.prototype = {
        ...
        _fnConstruct: function(t) {
            ...
            if (o.s.iLeftColumns > 0) {
                ...
                n(o.dom.grid.left.liner).bind("mousewheel", function(e) {
            ...
            if (o.s.iRightColumns > 0) {
                ...
                n(o.dom.grid.right.liner).bind("mousewheel", function(e) {
                    var t = e.originalEvent.wheelDeltaX / 3;
                    o.dom.scroller.scrollLeft -= t
                })
            }
        ...
        _fnGridLayout: function() {
            ...
            if (this.s.iLeftColumns > 0) {
                ...
                e.left.wrapper.style.height = i + "px";
        ...
        _fnClone: function(e, t, r, i) {
            ...
            if (this.s.dt.nTFoot !== null) {
                if (i) {
                    ...
                    for (o = 0, u = v.length; o < u; o++)
                        for (a = 0, f = v[o].length; a < f; a++) S[o][a].cell.className = v[o][a].cell.className
                }
        ...
        _fnEqualiseHeights: function(e, t, r) {
            ...
            var i = this,
                s, o, u, a, f, l, c = t.getElementsByTagName(e)[0],
