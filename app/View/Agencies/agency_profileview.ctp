      ...
      <div class="row">
        <div class="col-sm-12">
		  ...
		  <div class="pull-right">
				<a href="<?php echo SITEURL; ?>profileedit/<?php echo $this->data['User']['id']; ?>" class="btn btn-success btn-xs" >Edit </a>
          ...
          <div class="login-cell">
			...
			?>
                ...
                <div class="controls">
               	<?php $date = date('m/d/Y');
					if(isset($this->data['UserProfile']['age'])){
						echo $date = $this->data['UserProfile']['age'];						
					}
					?>
              </div>
              </div>
			  ...
			  <div class="form-group col-sm-6  col-lg-4">
				<label for="email" class="control-label"> Passport Scan Copy  </label>
					<div class="controls">
			...
			<div class="form-group col-sm-6  col-lg-4">
              ...
              <div class="form-group col-sm-6  col-lg-4">
                ...
                <div class="controls">
					<?php if(isset($this->data['User']['showpassword']) && !empty($this->data['User']['showpassword'])){ echo $this->data['User']['showpassword']; }else{ echo '-';  } ?>
                </div>
              </div>
