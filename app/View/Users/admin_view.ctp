    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="javascript:void(0);">View Admin Users</a>
                </li>
            </ul>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        <h3><i class="icon-th-list"></i> User - View User</h3>
                        <h3 style="float: right; margin-right: 10px; font-size: 13px;">
                            <?php echo $this->Html->link('Back',array('action'=>'user'),array('style'=>'color:#fff !important;'));?>
                        </h3>
                    </div>
                        ...
                        <?php echo $this->Form->input('User.id', array('type' => 'hidden', )); ?>
                            ...
                            <div class="control-group">
  							...
  							<div class="control-group">
                                ...
                                <div class="controls"><?php echo $users['User']['created'];?></div>
                            </div>
                            <div class="control-group">
                                <label for="textfield" class="control-label">Status</label>
                                <div class="controls"><?php echo ($users['User']['status'] == 0) ? 'Deactive' : 'Active'; ?></div>
                            </div>
