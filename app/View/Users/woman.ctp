<?php 
    ...
    echo $this->Form->input('UserVideo.id', array('type' => 'hidden'));

?>
<div class="control-group">
    <label for="textfield" class="control-label">Agency <span>*</span></label>
    <div class="controls">
    
    <?php echo $this->Form->input('UserProfile.agency_id', array('options'=> $this->Common->getAgencyList(), 'empty' => 'Select Agency','label' => false,'required' => true, 'div' => false, 'class' => 'select2-me input-xlarge')); ?>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $this->Form->input('UserProfile.nickname', array('label' => false ,'required' => true, 'div' => false, 'class' => 'input-xlarge')); ?>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    <label for="UserProfilePhone" class="control-label">Phone (Confidential)</label>
    <div class="controls">
        <?php echo $this->Form->input('UserProfile.phone', array('required' => false,'label' => false, 'div' => false, 'class' => 'input-xlarge mask_phone')); ?>
    </div>
</div>
<div class="control-group">
    <label for="textfield" class="control-label">Passport Number (Confidential)   <span>*</span> </label>
    <div class="controls">
        <?php echo $this->Form->input('UserProfile.passport_number', array('label' => false, 'div' => false, 'class' => 'input-xlarge')); ?>
    </div>
</div>
...
<div class="control-group">
    <label for="textfield" class="control-label">My Ideal Man   </label>
    <div class="controls">
...
<div class="control-group">
    <label for="textfield" class="control-label"> Passport Scan Copy (Confidential) <span>*</span> </label>
        <div class="controls">
        <?php echo $this->Form->input('UserProfile.passport_scan_copy', array('type' => 'file', 'label' => false, 'div' => false, 'class' => 'input-xlarge')); ?>
        <?php if (isset($this->request->data['UserProfile']['passport_scan_copy']) && !is_array($this->request->data['UserProfile']['passport_scan_copy']) && $this->request->data['UserProfile']['passport_scan_copy'] != '' && file_exists(WWW_ROOT . 'uploads' . DS . 'passport_scan_copy' . DS . $this->request->data['UserProfile']['passport_scan_copy'])) { ?>	
            <div class="catepic" style="float:none; width:200px;">
                ...
                echo $this->Html->link('Passport Scan Copy :' . $this->request->data['UserProfile']['passport_scan_copy'], array('controller' => 'users',
                    'action' => 'downloadfile',
...
<div class="control-group">
    <label for="textfield" class="control-label"> Profile Video  </label>
        <div class="controls">
        <?php echo $this->Form->input('UserVideo.profile_vedio', array('type' => 'file', 'label' => false, 'div' => false, 'class' => 'input-xlarge')); ?>
        <?php if (isset($this->request->data['UserVideo']['profile_vedio']) && !is_array($this->request->data['UserVideo']['profile_vedio']) &&  $this->request->data['UserVideo']['profile_vedio'] != '' && file_exists(WWW_ROOT . 'uploads' . DS . 'profile_vedio' . DS . $this->request->data['UserVideo']['profile_vedio'])) { ?>	
            ...
            <?php echo $this->Html->Image('tick.png', array('height' => 14, 'width' => 14)) ?>
                <?php
                echo $this->Html->link('Profile Vedio :' . $this->request->data['UserVideo']['profile_vedio'], array('controller' => 'users',
                    'action' => 'downloadfile',
