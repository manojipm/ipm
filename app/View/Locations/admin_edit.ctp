        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        <h3><i class="icon-th-list"></i> Testimonials - Edit Testimonial</h3>
                    </div>
                    <div class="box-content nopadding">
                        <?php echo $this->Form->create('Testimonial', array('type' => 'file', 'class' => 'form-horizontal form-bordered')); ?>
                        <?php echo $this->Form->input('Testimonials.id', array('type' => 'hidden')); ?>
                            ...
                            <label for="textfield" class="control-label">Status</label>
                                <div class="controls">
                                    ...
                                    echo $this->Form->checkbox('Testimonial.status', array(
                                        'checked' => isset($this->request->data['Testimonial']['status']) && $this->request->data['Testimonial']['status'] == 1 ? 'checked' : false,
                                        'hiddenField' => false,
                                    ));
                                    ?> 
                                </div>
