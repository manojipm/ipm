    ...
    <div class="container-fluid">
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="javascript:void(0);">Edit Country</a>
                </li>
            </ul>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-color box-bordered">
                    <div class="box-title">
                        <h3><i class="icon-th-list"></i> Country - Edit Country</h3>
                    </div>
                            ...
                            <label for="textfield" class="control-label">Status</label>
                                <div class="controls">
                                    ...
                                    echo $this->Form->checkbox('Country.status', array(
                                        'checked' => isset($this->request->data['Country']['status']) && $this->request->data['Country']['status'] == 1 ? 'checked' : false,
                                        'hiddenField' => false,
                                    ));
                                    ?> 
                                </div>
