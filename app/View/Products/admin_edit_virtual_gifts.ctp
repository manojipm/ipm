...
<div id='inline_content' style='padding:10px; background:#fff;'>
	<div class="box-title">
		<h3><i class="icon-th-list"></i> Edit Virtual Gift</h3>
	</div>
	<div class="box-content nopadding">
		<?php echo $this->Form->create('Product', array('action' => 'admin_edit_virtual_gifts','type' => 'file', 'class' => 'form-horizontal form-bordered')); ?>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				if(empty($errors)){
				?>
				<img src="<?php echo SITEURL. VIRPRODUCT_THUMB_FILE_PATH; ?><?php echo '/'.$this->data['Product']['image_file']; ?>" width="90" height="65" alt="">
				<?php } ?>
			</div>
		</div>
